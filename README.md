...
- **Code block** A clode block is used to define a block of code. It's mandatory to have one in a mehtod declaration and it's here where we will be adding statements to perform certain tasks.
